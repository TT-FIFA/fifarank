    ...
    children: [
      {
        path: '',
        loadChildren: () =>
          import('./players/player-list/player-list.module').then(
      ...
      },
      {
        path: ':playerId',
        loadChildren: () =>
          import('./players/player-details/player-details.module').then(
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: ':matchId',
        loadChildren: () =>
          import('./matches/match-details/match-details.module').then(
